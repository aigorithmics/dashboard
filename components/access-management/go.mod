...
replace (
	// Thrift often doesn't need a replace anymore unless you have specific legacy code
	git.apache.org/thrift.git => github.com/apache/thrift v0.13.0
	// Update Gnostic to the version that fixed the OpenAPIv2 case-sensitivity issue correctly
	github.com/googleapis/gnostic => github.com/googleapis/gnostic v0.5.5

	// Use matching versions for all K8s modules
